        ...
        <div class="row">
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#add" data-bs-whatever="@getbootstrap"  class="btn btn-sm btn-outline-primary float-end col-12 mt-2 col-sm-3 "><i class="bi bi-plus"></i> Nouvelle vente</button> 
