    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4 text-dark" >
        <li class="nav-item dropdown bg-light rounded-2">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="navbarDropdown" >
                ...
                <li><a class="dropdown-item" href="{{route('accueil')}}"><i class="bi bi-box-arrow-left"></i> Deconnexion</a></li>
            </ul>
        </li>
    </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer" style='background:rgba(255, 68, 0, 0.062)'>
        <button type="button" class="btn btn-default" style="border:1px solid rgba(0, 0, 0, 0.712)" data-bs-dismiss="modal">Fermer</button>
        <button type="button" class="btn text-light" style='background:orangered'>Enregistrer</button>
      </div>
    </div>
  </div>
</div>