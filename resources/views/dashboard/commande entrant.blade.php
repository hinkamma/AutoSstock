        ...
        <div class="row">
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#add" data-bs-whatever="@getbootstrap"  class="btn btn-sm btn-primary float-end col-12 mt-2  col-sm-3 "><i class="bi bi-folder-plus"></i> Nouveau stock</button> 
                                ...
                                <td>
                                    <div class="row gap-2">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-info">
                                                            <h1 class="modal-title fs-5 text-light" id="exampleModalLabel">Inserer un article</h1>
                                                            <button type="button" class="btn-close text-light" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form>
                                        ...
                                        <div class="col-4 col-sm-6 col-lg-2 col-xl-1">
                                            <a href="{{route('dashboard.liste_produit_entrant')}}" title="liste des stock" class="btn btn-sm btn btn-default"><i class="bi bi-list"></i></i></a>
                                        </div>
