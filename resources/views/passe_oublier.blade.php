     ...
     <div class="container-fluid   d-flex justify-content-center align-items-center vh-100">
        <div class="card " style="width: 18rem;" data-aos="fade-in" data-duration="5000" data-aos-delay="200" data-aos-easing="ease-in-out">
            <form action="" method="post">
                ...
                <div>
                    <p class="fs-5 fw-bold text-center">Mot de passe oublié ?</p>
                    <p class="fs-6 text-center">Vous recevrez un lien pou le reinitiliser</p>
                </div>
                ...
                <div class="mb-3">
                   <button style="width:100%; background:orangered;color:white" class="btn  mt-4">REINITIALISER MON MOT DE PASSE</button>
                </div>
